...
$pdf->SetAuthor('BB&O');
$pdf->SetTitle('magnoliapark_01MW');
...
$pdf->WriteHTMLCell(14.7857, 3.8125, 101.643, 4, '<b>HOLE</b>: 1', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(19.7143, 3.8125, 116.429, 4, '<b>PAR</b>: 5', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(29.5714, 3.8125, 136.143, 4, '<b>LENGTH</b>: 543', 1, 0, true, false, 'L', false);
...
$pdf->WriteHTMLCell(12.3214, 3.8125, 49.8929, 11.625, '220 ', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(12.3214, 3.8125, 62.2143, 11.625, '73 ', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(12.3214, 3.8125, 37.5714, 15.4375, '192L', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(12.3214, 3.8125, 49.8929, 15.4375, '170 ', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(12.3214, 3.8125, 62.2143, 15.4375, '181T', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
...
$pdf->WriteHTMLCell(24.6429, 3.8125, 62.2143, 19.25, '<b> Bogey: </b>Yes', 1, 0, true, false, 'C', false);
// -------- Roll -------------
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(0, 0, 0);
...
$pdf->WriteHTMLCell(24.6429, 3.8125, 37.5714, 26.875, 'Down Sig', 1, 0, true, false, 'C', false);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(24.6429, 3.8125, 37.5714, 30.6875, '-3', 1, 0, true, false, 'C', false);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(24.6429, 3.8125, 37.5714, 34.5, '-2', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(24.6429, 3.8125, 37.5714, 38.3125, '-1', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->WriteHTMLCell(24.6429, 3.8125, 37.5714, 42.125, '<b>-6</b>', 1, 0, true, false, 'C', false);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 91.6875, '+32', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 91.6875, '+41', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 95.5, '+4', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 95.5, '+3', 1, 0, true, false, 'C', false);
...
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 99.3125, '', 1, 0, true, false, 'C', false);
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 57.2857, 99.3125, '-1', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 103.125, '+1', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 103.125, '+2', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 106.938, '+1', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 106.938, '', 1, 0, true, false, 'C', false);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 110.75, '-1', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 118.375, '+6', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 118.375, '+4', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 57.2857, 118.375, '+7', 1, 0, true, false, 'C', false);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(19.7143, 3.8125, 37.5714, 122.188, '+6', 1, 0, true, false, 'C', false);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(19.7143, 3.8125, 37.5714, 126, '1', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->WriteHTMLCell(19.7143, 3.8125, 37.5714, 129.812, '<b>+7</b>', 1, 0, true, false, 'C', false);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 67.1429, 45.9375, '+20', 1, 0, true, false, 'R', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(14.7857, 3.8125, 57.2857, 49.75, 'Sc: -50', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(14.7857, 3.8125, 72.0714, 49.75, 'Bo: +8', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(29.5714, 3.8125, 57.2857, 53.5625, 'Dogleg', 1, 0, true, false, 'C', false);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(29.5714, 3.8125, 57.2857, 57.375, 'Water', 1, 0, true, false, 'C', false);
// -------- Topography -------------
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(0, 0, 0);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(14.7857, 3.8125, 57.2857, 61.1875, 'Sc: +10', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(14.7857, 3.8125, 72.0714, 61.1875, 'Bo: +820', 1, 0, true, false, 'C', false);
...
$pdf->SetFillColor(247, 253, 156);
$pdf->WriteHTMLCell(39.4286, 3.8125, 146, 65, 'Greater than 3/4', 1, 0, true, false, 'L', false);
$pdf->SetFillColor(255, 255, 255);
...
$pdf->SetFillColor(255, 255, 255);
$pdf->SetFillColor(127, 127, 127);
$pdf->WriteHTMLCell(9.85714, 3.8125, 136.143, 80.25, '', 1, 0, true, false, 'L', false);
$pdf->SetFillColor(255, 255, 255);
$pdf->SetFillColor(127, 127, 127);
...
$pdf->SetFillColor(247, 253, 156);
$pdf->WriteHTMLCell(12.8143, 3.8125, 106.571, 179.375, '800', 0, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(12.8143, 3.8125, 150.929, 179.375, '810', 0, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(12.8143, 3.8125, 195.286, 179.375, '0', 0, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(12.8143, 3.8125, 239.643, 179.375, '820', 0, 0, true, false, 'L', false);
// -------- End of Page -------------
$pdf->Output('magnoliapark_01MW.pdf', 'I');
?>