...
$pdf->MultiCell(44.3571, 4.30435, '<b>COURSE</b>: Men Yellow', 1, 'J', true, 0,57.2857, 4, false, 0, true, true, 4.30435,'M',false);
...
$pdf->MultiCell(29.5714, 4.30435, '<b>LENGTH</b>: 290', 1, 'J', true, 0,136.143, 4, false, 0, true, true, 4.30435,'M',false);
...
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214, 4.30435, '170', 1, 'J', true, 0,37.5714, 12.6087, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(255,255,255);
...
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214, 4.30435, '170', 1, 'J', true, 0,37.5714, 16.913, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(255,255,255);
...
$pdf->Output('oaklandpark_13MB.pdf', 'I');
?>