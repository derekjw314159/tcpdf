...
$pdf->SetAuthor('BB&O');
$pdf->SetTitle('ritchingspark_02MR');
...
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214, 4.30435, '158', 1, 'J', true, 0,37.5714, 16.913, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(127,127,127);
...
$pdf->Output('ritchingspark_02MR.pdf', 'I');
?>