...
$pdf->SetAuthor('BB&O');
$pdf->SetTitle('ritchingspark_02WR');
$pdf->SetSubject('Course Rating');
$pdf->SetKeywords('Rating, ritchingspark');
...
$pdf->MultiCell(49.2857, 4.30435, '<b>CLUB</b>: Ritchings Park GC', 1, 'J', true, 0,8, 4, false, 0, true, true, 4.30435,'M',false);
$pdf->MultiCell(44.3571, 4.30435, '<b>COURSE</b>: Women Red', 1, 'J', true, 0,57.2857, 4, false, 0, true, true, 4.30435,'M',false);
$pdf->MultiCell(14.7857, 4.30435, '<b>HOLE</b>: 2', 1, 'J', true, 0,101.643, 4, false, 0, true, true, 4.30435,'M',false);
$pdf->MultiCell(19.7143, 4.30435, '<b>PAR</b>: 4', 1, 'J', true, 0,116.429, 4, false, 0, true, true, 4.30435,'M',false);
$pdf->MultiCell(29.5714, 4.30435, '<b>LENGTH</b>: 158', 1, 'J', true, 0,136.143, 4, false, 0, true, true, 4.30435,'M',false);
...
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214, 4.30435, '158', 1, 'J', true, 0,37.5714, 12.6087, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(127,127,127);
$pdf->MultiCell(12.3214, 4.30435, ' ', 1, 'J', true, 0,49.8929, 12.6087, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(127,127,127);
...
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214, 4.30435, '158T', 1, 'J', true, 0,37.5714, 16.913, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(127,127,127);
$pdf->MultiCell(12.3214, 4.30435, ' ', 1, 'J', true, 0,49.8929, 16.913, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(127,127,127);
...
$pdf->MultiCell(24.6429, 4.30435, '<span style="text-align:center"><b> Bogey: </b>Yes</span>', 1, 'J', true, 0,62.2143, 21.2174, false, 0, true, true, 4.30435,'M',false);
$pdf->Output('ritchingspark_02WR.pdf', 'I');
?>