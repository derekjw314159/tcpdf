...
$pdf->SetAuthor('BB&O');
$pdf->SetTitle('magnoliapark_01MB');
...
$pdf->WriteHTMLCell(44.3571, 3.8125, 57.2857, 4, '<b>COURSE</b>: Men Yellow', 1, 0, true, false, 'L', false);
...
$pdf->WriteHTMLCell(29.5714, 3.8125, 136.143, 4, '<b>LENGTH</b>: 508', 1, 0, true, false, 'L', false);
...
$pdf->WriteHTMLCell(12.3214, 3.8125, 62.2143, 11.625, '38 ', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(12.3214, 3.8125, 37.5714, 15.4375, '201R', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(12.3214, 3.8125, 49.8929, 15.4375, '170 ', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(12.3214, 3.8125, 62.2143, 15.4375, '137 ', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
...
$pdf->setFillColor(255, 255, 255);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 91.6875, '', 1, 0, true, false, 'C', false);
...
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 95.5, '+8', 1, 0, true, false, 'C', false);
...
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 103.125, '', 1, 0, true, false, 'C', false);
...
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 110.75, '', 1, 0, true, false, 'C', false);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 118.375, '+4', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 118.375, '+8', 1, 0, true, false, 'C', false);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 67.1429, 45.9375, '+820', 1, 0, true, false, 'R', false);
$pdf->setFillColor(255, 255, 255);
...
// -------- End of Page -------------
$pdf->Output('magnoliapark_01MB.pdf', 'I');
?>