...
$pdf->SetAuthor('BB&O');
$pdf->SetTitle('magnoliapark_03MW');
...
$pdf->WriteHTMLCell(14.7857, 3.8125, 101.643, 4, '<b>HOLE</b>: 3', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(19.7143, 3.8125, 116.429, 4, '<b>PAR</b>: 5', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(29.5714, 3.8125, 136.143, 4, '<b>LENGTH</b>: 489', 1, 0, true, false, 'L', false);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(12.3214, 3.8125, 49.8929, 11.625, '239T', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(12.3214, 3.8125, 62.2143, 15.4375, '119 ', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(24.6429, 3.8125, 37.5714, 19.25, '<b>Scratch: </b>Yes', 1, 0, true, false, 'C', false);
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
...
$pdf->setTextColor(0, 0, 0);
$pdf->setFillColor(255, 255, 255);
$pdf->WriteHTMLCell(29.5714, 3.8125, 8, 26.875, '<i>Slope in Tee Shot LZ</i>', 1, 0, true, false, 'C', false);
$pdf->setTextColor(0, 0, 0);
...
$pdf->WriteHTMLCell(9.85714, 3.8125, 27.7143, 106.938, '<b>+W</b>', 0, 0, true, false, 'R', false);
$pdf->setTextColor(0, 0, 0);
$pdf->setFillColor(255, 255, 255);
...
$pdf->WriteHTMLCell(9.85714, 3.8125, 27.7143, 110.75, '<b>-W</b>', 0, 0, true, false, 'R', false);
$pdf->setTextColor(0, 0, 0);
$pdf->setFillColor(255, 255, 255);
...
$pdf->setTextColor(0, 0, 0);
$pdf->setFillColor(255, 255, 255);
$pdf->WriteHTMLCell(29.5714, 3.8125, 8, 114.562, '<i>Obstructed</i>', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 27.7143, 114.562, '<b>O</b>', 0, 0, true, false, 'R', false);
$pdf->setTextColor(0, 0, 0);
$pdf->setFillColor(255, 255, 255);
...
$pdf->WriteHTMLCell(9.85714, 3.8125, 27.7143, 126, '<b>U</b>', 0, 0, true, false, 'R', false);
$pdf->setTextColor(0, 0, 0);
$pdf->setFillColor(255, 255, 255);
...
$pdf->WriteHTMLCell(19.7143, 3.8125, 37.5714, 129.812, '+8', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(29.5714, 3.8125, 57.2857, 129.812, '+8', 1, 0, true, false, 'C', false);
...
// -------- End of Page -------------
$pdf->Output('magnoliapark_03MW.pdf', 'I');
?>