...
$pdf->SetAuthor('BB&O');
$pdf->SetTitle('magnoliapark_04MW');
...
$pdf->WriteHTMLCell(14.7857, 3.8125, 101.643, 4, '<b>HOLE</b>: 4', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(19.7143, 3.8125, 116.429, 4, '<b>PAR</b>: 4', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(29.5714, 3.8125, 136.143, 4, '<b>LENGTH</b>: 428', 1, 0, true, false, 'L', false);
...
$pdf->WriteHTMLCell(12.3214, 3.8125, 49.8929, 11.625, '178 ', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
...
$pdf->WriteHTMLCell(12.3214, 3.8125, 62.2143, 15.4375, '58 ', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
...
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 91.6875, '+40', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 91.6875, '', 1, 0, true, false, 'L', false);
$pdf->setTextColor(0, 0, 0);
$pdf->setFillColor(247, 253, 156);
$pdf->WriteHTMLCell(9.85714, 3.8125, 57.2857, 91.6875, '+21', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 67.1429, 91.6875, '+40', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
$pdf->WriteHTMLCell(9.85714, 3.8125, 77, 91.6875, '', 1, 0, true, false, 'L', false);
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 95.5, '+3', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
$pdf->WriteHTMLCell(9.85714, 3.8125, 47.4286, 95.5, '', 1, 0, true, false, 'L', false);
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(9.85714, 3.8125, 57.2857, 95.5, '+7', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(9.85714, 3.8125, 67.1429, 95.5, '+3', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(9.85714, 3.8125, 37.5714, 118.375, '+3', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
...
$pdf->WriteHTMLCell(9.85714, 3.8125, 67.1429, 118.375, '+3', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(19.7143, 3.8125, 37.5714, 122.188, '+3', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(29.5714, 3.8125, 57.2857, 122.188, '+7', 1, 0, true, false, 'C', false);
$pdf->setTextColor(0, 0, 0);
$pdf->setFillColor(255, 255, 255);
...
$pdf->WriteHTMLCell(19.7143, 3.8125, 37.5714, 129.812, '<b>+3</b>', 1, 0, true, false, 'C', false);
$pdf->WriteHTMLCell(29.5714, 3.8125, 57.2857, 129.812, '<b>+7</b>', 1, 0, true, false, 'C', false);
// -------- Elevation -------------
$pdf->setFillColor(0, 0, 0);
...
// -------- End of Page -------------
$pdf->Output('magnoliapark_04MW.pdf', 'I');
?>