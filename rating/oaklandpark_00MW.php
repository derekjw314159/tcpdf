...
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214,4.30435,'174',1, 'J', true, 0,49.8929,16.913, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(127,127,127);
...
$pdf->Output('oaklandpark_00MW.pdf', 'I');
?>