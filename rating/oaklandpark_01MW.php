...
$pdf->MultiCell(14.7857, 4.30435, '<b>HOLE</b>: 1', 1, 'J', true, 0,101.643, 4, false, 0, true, true, 4.30435,'M',false);
$pdf->MultiCell(19.7143, 4.30435, '<b>PAR</b>: 4', 1, 'J', true, 0,116.429, 4, false, 0, true, true, 4.30435,'M',false);
$pdf->MultiCell(29.5714, 4.30435, '<b>LENGTH</b>: 374', 1, 'J', true, 0,136.143, 4, false, 0, true, true, 4.30435,'M',false);
...
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214, 4.30435, '250', 1, 'J', true, 0,37.5714, 12.6087, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214, 4.30435, '124', 1, 'J', true, 0,49.8929, 12.6087, false, 0, true, true, 4.30435,'M',false);
...
$pdf->SetFillColor(255,255,255);
$pdf->MultiCell(12.3214, 4.30435, '174T', 1, 'J', true, 0,49.8929, 16.913, false, 0, true, true, 4.30435,'M',false);
$pdf->SetFillColor(127,127,127);
...
$pdf->Output('oaklandpark_01MW.pdf', 'I');
?>