...
$pdf->SetAuthor('BB&O');
$pdf->SetTitle('magnoliapark_18MW');
...
$pdf->WriteHTMLCell(14.7857, 3.8125, 101.643, 4, '<b>HOLE</b>: 18', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(19.7143, 3.8125, 116.429, 4, '<b>PAR</b>: 5', 1, 0, true, false, 'L', false);
$pdf->WriteHTMLCell(29.5714, 3.8125, 136.143, 4, '<b>LENGTH</b>: 536', 1, 0, true, false, 'L', false);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(12.3214, 3.8125, 62.2143, 11.625, '66 ', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
...
$pdf->setTextColor( 35,  83, 216);
$pdf->setFillColor(176, 224, 230);
$pdf->WriteHTMLCell(12.3214, 3.8125, 62.2143, 15.4375, '166 ', 1, 0, true, false, 'C', false);
$pdf->setTextColor(255, 255, 255);
$pdf->setFillColor(180, 180, 180);
...
// -------- End of Page -------------
$pdf->Output('magnoliapark_18MW.pdf', 'I');
?>